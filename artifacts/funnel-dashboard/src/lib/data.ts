...
export const clarityInsights: ClarityInsight[] = [
  {
    id: "checkout-stuck",
    severity: "critical",
    title: "Checkout: تفاعل عالي بدون إكمال الطلب",
    arabicSummary:
      'مستخدمين كتير دخلوا الـ Checkout، كتبوا بياناتهم، ضغطوا على الحقول الخفية للدفع وعلى زر "تأكيد الطلب" — ومحدش أكمل.',
    whatItMeans:
      "في فشل تقني أو UX في صفحة الدفع — إما الفورم بيرفض البيانات، أو زر التأكيد مش بيشتغل، أو حقول الدفع مش بتقبل الإدخال.",
    funnelStage: "Checkout",
    affectedSessions: 38516616,
    diagnosis:
      "Form Validation Failure أو Submit Button Broken — الأخطر لأن المستخدم وصل لآخر خطوة وعنده نية شراء واضحة، والمنتج بيخسر الفلوس بعد ما الإعلان دفع تكلفته كاملة.",
    recommendation:
      "افتحي Checkout بنفسك من موبايل وكمبيوتر، جربي 3 طرق دفع، ركّزي على رسائل الخطأ. شيكي على الـ Pixel والـ Conversion API. لو في 3D Secure تأكدي إنه بيرجّع المستخدم تاني للموقع.",
    expectedImpact:
  ...
  },
  {
    id: "offer-stalled",
    severity: "high",
    title: "العروض: المستخدم يضغط ويتوقف",
    arabicSummary:
      'سيشنز كتير ضغطت على "عرض قطعتين" أو "الحق العرض واطلبها"، عملت شوية تفاعل، وبعدين وقفت من غير ما تكمّل.',
    whatItMeans:
      "ضعف في الـ Conversion Flow — الضغط على العرض بيفتح حاجة (Modal/Popup/Section) لكن مفيش CTA واضح بعدها يوديه للـ Cart أو Checkout مباشرة.",
    funnelStage: "Offer",
    affectedSessions: 25666,
    diagnosis:
      "Dead End بعد Click على العرض. المستخدم أبدى نية شراء صريحة لكن الصفحة ما خدتش بإيده للخطوة اللي بعدها.",
    recommendation:
      'بعد ضغط العرض، روح مباشرة لصفحة Checkout أو افتح Cart Drawer فيه زر "اطلب دلوقتي" واضح. شيل أي خطوة وسطية.',
    expectedImpact:
      "تحسين الـ Offer→Checkout flow ممكن يرفع الـ CR من 7.14% لـ 9-10% على نفس الترافيك.",
  },
  {
    id: "ad-mismatch",
    severity: "high",
  ...
  },
  {
    ...
    severity: "medium",
    title: "وقت طويل في الصفحة بدون Add to Cart",
    arabicSummary:
      "في مستخدمين قعدوا أكتر من دقيقة في صفحة المنتج، شافوا وقروا وعملوا Scroll، وخرجوا من غير ما يضيفوا للسلة.",
    whatItMeans:
      "تردّد في القرار — High Intent بدون شراء. المستخدم مهتم لكن في حاجز ثقة أو سعر أو وضوح في العرض.",
    funnelStage: "Landing",
    affectedSessions: 413657,
    diagnosis:
      "نقص في عناصر الإقناع: Reviews, Trust Badges, ضمان استرجاع، توضيح طريقة الدفع COD، توضيح الشحن.",
    recommendation:
      "ضيفي: تقييمات نجوم + Reviews فيديو، شارة ضمان استرجاع 14 يوم، Sticky CTA بيتابع الـ Scroll، صور قبل/بعد إضافية، توضيح إن الدفع عند الاستلام متاح.",
    expectedImpact:
      "تحويل 10% من اللي بيقعدوا دقيقة بدون شراء = +20 طلب إضافي على نفس الترافيك حالياً.",
  },
];
...
export const actionPlan: ActionItem[] = [
  {
    id: "fix-checkout",
    priority: "fix",
    title: "افتحي وجربي Checkout دلوقتي على موبايل + كمبيوتر",
    why: "Clarity بيقول مستخدمين بيضغطوا Confirm Order ومش بيكمّل. ده أكبر مصدر للخسارة.",
  ...
  },
  {
    id: "fix-offer-flow",
    priority: "fix",
    title: "وصّلي زر العرض مباشرة لـ Checkout (شيلي الخطوات الوسطية)",
    why: 'Clarity: ضغطات على "عرض قطعتين" بدون Continuation.',
  },
  {
    id: "fix-trust",
    priority: "fix",
    title: "ضيفي Reviews + ضمان استرجاع + Sticky CTA",
    why: "Clarity: 413K سيشن قعدوا أكتر من دقيقة بدون Add to Cart = تردّد في الثقة.",

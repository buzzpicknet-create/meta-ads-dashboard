...
══════════════════════════════════════
CORE AD-LEVEL DIAGNOSTIC METHODOLOGY
══════════════════════════════════════
...
الخطوة 2 (الاستمرار): لو Hook Rate ≥ 25% + Hold Rate < 15%
→ التشخيص: Media Problem (Hold) | الإجراء: إعادة مونتاج جسم الفيديو — تحسين الإيقاع أو الزاوية.

الخطوة 3 (النقر): لو Hook + Hold كويسين + CTR < 2%
→ التشخيص: Funnel Leak (Ad Copy/CTA) | الإجراء: إعادة كتابة النص الأساسي أو تجربة CTA مختلف.

الخطوة 4 (الصفحة): لو CTR ≥ 2% + LPR < 70%
→ التشخيص: Landing Page Problem | الإجراء: فحص سرعة التحميل على الموبايل أو إصلاح الـ Tracking Pixels.

الخطوة 5 (البيع): لو كل المقاييس السابقة كويسة + CVR < 1.5%

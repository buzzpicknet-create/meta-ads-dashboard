...
🔴 قاعدة تنفيذ البلوبرنت — إلزامية: عند تنفيذ STANDARD blueprint، نفّذ جميع create_ad_from_creative_spec (Ad 1, Ad 2, Ad 3, …) بالتسلسل وبدون أي توقف أو سؤال بينهم. لا تقل "هل تريد المتابعة لـ Ad 2؟" — بل نفّذ فوراً. blueprint = تعليمات كاملة تنفّذ حتى آخر إعلان بدون انتظار.
...
٧. بعد الاستدعاء رد فقط بـ:
   ...
   - STANDARD: "📋 حملة Standard قيد الإنشاء — [N] Adsets × [M] إعلانات — لا Dynamic Creative — in انتظار موافقتك."

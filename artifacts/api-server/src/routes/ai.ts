...
قواعد اختيار الميديا:
  ...
  - إذا وُجد اسم ملف مثل asset_file_name/video_file_name:
    ...
    * لو الملف غير موجود → اختَر ملف عشوائي من نفس الفولدر → selection_reason = random_missing_asset_name
  - إذا لا يوجد اسم ملف → اختَر ملف عشوائي من الفولدر → selection_reason = random_no_asset_name
...
٤. قواعد Drive matching:
   ...
   - إذا وُجد اسم ملف ولم يتطابق → يختار ملف عشوائي من نفس الفولدر.
   - إذا لا يوجد اسم ملف → يختار ملف عشوائي من الفولدر.
            ...
            items: {
              ...
              properties: {
                ...
                headline: { type: "string", description: "(للتوافق فقط)" },
                  asset_file_name: { type: "string", description: "اسم ملف فيديو/صورة مطلوب للمطابقة داخل Drive. إذا لم يوجد، يتم اختيار ملف عشوائي." },
                  asset_file_names: { type: "array", items: { type: "string" }, description: "أسماء ملفات متعددة بنفس ترتيب النصوص/العناوين. إذا لم يوجد اسم، يتم اختيار ملف عشوائي." },

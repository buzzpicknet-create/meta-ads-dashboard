...
🔴 قاعدة التوفير — إلزامية:
- استدعِ get_campaigns مرة واحدة فقط لكل طلب تحليل.
- لا تستدعِ get_ads_in_adset إلا لو المستخدم طلب تحليل إعلانات بالتفصيل صراحةً.
- لا تستدعِ get_campaign_daily أو get_account_daily إلا لو طُلب تحليل يومي.
- استخدم tools فقط للبيانات المطلوبة فعلاً.
